    ...
    <form action="./UserServlet" method="POST">
        <div class="container" align="center">
            <div class="form-group">
                <label>Nome</label>
                <input  class="form-control" name="nome" aria-describedby="emailHelp" placeholder="Digite o seu nome">
            </div>
            <div class="form-group">
                <label >País</label>
            ...
            <div class="form-group">
                ...
                <input class="form-control" name="password"  type="password" placeholder="Digite a nova password">
            </div>
            <button type="submit" name="action" value="edit_user" class="btn btn-primary">Guardar</button>
            <button type="submit" name="action" value="remove_user" class="btn btn-primary">Apagar Conta</button>
        </div>
    </form>
